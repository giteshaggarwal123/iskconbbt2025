        ...
        <div className="p-6">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-10 mt-4">
            ...
            <div className="mb-6 pb-6 border-b">
              ...
              <div className="mb-4">
                <Label className="font-semibold" htmlFor="meeting-id">Meeting ID</Label>
                <Input
                  id="meeting-id"
                  className="mt-1 font-mono text-base w-fit"
                  value={meetingId}
                  onChange={e => setMeetingId(e.target.value)}
                  maxLength={32}
                  required
                />
                <div className="text-xs text-gray-500 mt-1">This ID will be assigned to the meeting and must be unique.</div>
              </div>
